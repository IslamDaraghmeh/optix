<nav x-data="{ open: false }"
    class="bg-white border-b-2 border-primary-200 shadow-lg sticky top-0 z-50 transition-all duration-300">
            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}"
                        ...
                        <div
                            class="w-10 h-10 bg-primary-500 rounded-lg flex items-center justify-center shadow-lg group-hover:shadow-xl transition-all duration-300 group-hover:rotate-3">
                        ...
                        <span class="text-xl font-bold text-primary-600">{{ __('app.name') }}</span>
                    </a>
                </div>
